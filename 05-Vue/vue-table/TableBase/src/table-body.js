import { arrayFindIndex } from 'element-ui/lib/utils/util';
import { getCell, getColumnByCell, getRowIdentity } from './util';
import { getStyle, hasClass, removeClass, addClass } from 'element-ui/lib/utils/dom';
        ...
        if (cur) {
          ...
          if (typeof cur.lazy === 'boolean') {
            if (typeof cur.loaded === 'boolean' && cur.loaded) {
              treeRowData.noLazyChildren = !(cur.children?.length);
            }
          ...
          const traverse = (children, parent) => {
            ...
            children.forEach(node => {
              ...
              if (cur) {
                ...
                if (typeof cur.lazy === 'boolean') {
                  if (typeof cur.loaded === 'boolean' && cur.loaded) {
                    innerTreeRowData.noLazyChildren = !(cur.children?.length);
                  }
