...
type GetGetter<GetterType> = GetterType extends { getters: infer G }
  ? G
  : unknown;
...
type GetMutation<MutationType> = MutationType extends { mutations: infer M }
  ? M
  : unknown;
...
type GetAction<ActionType> = ActionType extends { actions: infer A }
  ? A
  : unknown;
